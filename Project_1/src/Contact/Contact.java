...
public class Contact {
	...
	//adding Bytes and limits to look similar to other code I made
	...
	Contact() {
	  ...
	  protected void updateFirstName(String firstName) {
	    if (firstName == null || firstName.length() > CONTACT_FNAME_LENGTH) {
	      throw new IllegalArgumentException("First name cannot be empty or have more than "  + CONTACT_FNAME_LENGTH + " characters");
	    } else {
	  ...
	  protected void updateLastName(String lastName) {
	    if (lastName == null || lastName.length() > CONTACT_LNAME_LENGTH) {
	      throw new IllegalArgumentException("Last name cannot be empty or have more than " + CONTACT_LNAME_LENGTH + " characters");
	    } else {
	  ...
	  protected void updateAddress(String address) {
	    if (address == null || address.length() > CONTACT_ADDRESS_LENGTH) {
	      throw new IllegalArgumentException("Address cannot be empty and cannot be more than " + CONTACT_ADDRESS_LENGTH + " characters");
	    } else {
	  ...
	  protected void updateContactId(String contactId) {
	    if (contactId == null || contactId.length() > CONTACT_ID_LENGTH) {
	      throw new IllegalArgumentException("Contact ID cannot be empty and cannot be more than " + CONTACT_ID_LENGTH + " characters");
	    } else {
